<?php $this->view('dashboard/_layouts/header', $data) ?>
    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-6">
            <div class="col"><h5>Edit Data Baju</h5></div>
            <div class="col-auto">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= BASE_URL.'/admin/dashboard/clothes/update/'.$clothe->id ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-8">
                                <label for="">Foto Baju (current: <?= $clothe->photo; ?>)</label>
